...
public class StandAloneProgram {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Declaring variables
        String email = "adas@gmail.com";
        String pwd = "Test@123";
        String coat = "ZARA COAT 3";


        //Enter email
        driver.findElement(By.xpath("//input[@placeholder='email@example.com']")).sendKeys(email);
        //Enter password
        ...
        item1.findElement(By.cssSelector("button[class='btn w-10 rounded']")).click();
